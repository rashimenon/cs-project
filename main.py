...
back_surface = pygame.image.load('back.png').convert_alpha()
...
game_start_surface = pygame.image.load('gamestart.png').convert_alpha()
...
pomodoro_surface = pygame.image.load('pomodoro.jpg').convert_alpha()
...
while True:
    ...
    if pause.draw(screen):
        ...
        played = True   
    if played:
        pause = pause_surface = pygame.image.load('play.png').convert_alpha()
        pause = button.Button(472,453, pause_surface, 0.08)
    else: 
        pause = pause_surface = pygame.image.load('pause.png').convert_alpha()
        pause = button.Button(472,453, pause_surface, 0.05)
